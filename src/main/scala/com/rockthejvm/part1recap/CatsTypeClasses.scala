...
object CatsTypeClasses {
  ...
  val flatMapList = FlatMap[List] // flatMap extension method
  ...
  val unDesirableValue: ErrorOr[Int] = appErrorEither.raiseError("Something failed")

  import cats.syntax.applicativeError.* // raise error extension method
